 ...
 * Full onboarding form for registering a new hospital in the system.
 */
        ...
        <div className="px-6 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Onboard a new healthcare facility to the ClearMed network
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative max-w-2xl mx-auto px-6 py-10 space-y-6">
        {success && (
          <Alert className="bg-green-500/10 border-green-500/30">
            ...
            <AlertTitle>Hospital registered</AlertTitle>
            <AlertDescription>
              <strong>{createdName}</strong> has been added to the network.{" "}
              <button
        ...
        <Card className="data-visualization">
          <CardHeader>
            <CardTitle className="text-foreground">Hospital details</CardTitle>
            <CardDescription>
              All fields are required. The licence number must be unique across
              the system.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. 1 Idi-Araba, Surulere"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. HOSP-20240001"
                  required
                />
                <p className="text-xs text-muted-foreground">
                  Must be unique. Used for verification and audit.
                </p>
              </div>
