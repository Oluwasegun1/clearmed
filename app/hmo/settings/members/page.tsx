...
/**
 * HMO Admin — Staff Members management.
 * /hmo/settings/members
 */
...
export default function HMOMembersPage() {
  ...
  // Resolve orgId from HMOStaff or OrgMembership
  useEffect(() => {
  ...
  return (
    <HMOSidebarWrapper currentPath="/hmo/settings/members" role={UserRole.HMO_ADMIN}>
        ...
        <div className="relative border-b border-border/50 bg-card/30 backdrop-blur-xl px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold flex items-center gap-2">
              <Users className="h-6 w-6 text-primary" /> HMO Staff Members
            </h1>
            <p className="text-sm text-muted-foreground">Manage staff access to your HMO organization</p>
          </div>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base flex items-center gap-2">
                    <MailIcon className="h-4 w-4" /> Invite an HMO staff member
                  </CardTitle>
